...
// export const Footer = () => {
//   return (
//     <footer className={`${inter.className} grid grid-cols-1 md:grid-cols-2 space-y-10 w-full bg-black text-white p-10 md:p-30 `}>  
//         <div className='flex flex-col space-y-6 items-center text-md '>
//             <div className='flex items-center justify-center md:justify-start space-x-4 w-[24rem]'>
//                 <Image
...
//                 />
//                 <h5 className={`${notable.className}`}>REKHIA UX & <br/>SOFTWARE STUDIO</h5>                
//             </div>


//             <div className='flex flex-col space-y-3 text-center md:text-start  w-[24rem]'>
//                 <p className="text-xs">Simple solutions, scalable foundations, and a vision that goes<br/> 
//                     beyond the present. Rekhia blends practical execution<br/>  
//                     with bold imagination.
//                 </p>
//                 <p className="text-xs hidden md:block">© 2025 Busdigital LLC All rights reserved</p>
//             </div>
//         </div>
...
//                         <li className="text-sm hover:underline cursor-pointer">FAQ</li>
...
//                 <CtaButton text="Get in Touch" classes="hidden md:block hover:border-red-500 transition-all duration-500 bg-white text-black mt-8 font-bold"/>             
//             </div>

            
//         </div>

//         <p className="text-xs text-center md:hidden">© 2025 Busdigital LLC All rights reserved</p>
//     </footer>
//   )
// }
