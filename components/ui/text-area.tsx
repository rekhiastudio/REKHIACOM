...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => {
    const radius = 100; // tamaño del efecto hover
      ...
      >
        <textarea
          ...
          className={cn(
            ...
            flex w-full rounded-md border-none bg-gray-50 px-3 py-2 
            text-sm text-black transition duration-400 
            group-hover/textarea:shadow-none 
            ...
            h-24 resize-none overflow-y-auto overflow-x-hidden 
